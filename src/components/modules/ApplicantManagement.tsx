              ...
              <CardContent className="flex flex-1 flex-col p-5">
                  ...
                  {monthCells.map((cell) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "relative h-[2.6rem] border-b border-r border-border/70 text-sm transition-colors last:border-r-0",
                ...
                <div className="mt-3 flex flex-wrap gap-4 text-xs text-muted-foreground">
                  ...
                  <div className="relative mt-2 min-h-0 flex-1">
                    <div className="max-h-[16rem] space-y-2 overflow-y-auto pr-1.5">
                      {interviews
