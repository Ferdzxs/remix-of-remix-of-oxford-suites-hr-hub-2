...
export function NewHireOnboarding({ role }: { role: "superadmin" | "admin" }) {
  ...
  /** Hires whose employee portal account has been created (probationary onwards). */
      ...
      >
        <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              {completingId
                ? "This hire has moved to Probationary — confirm their details before the portal account is created."
